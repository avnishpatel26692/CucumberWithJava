...
public class Steps4Task2 {
    ...
    public void fill_all_fields(String arg1, String arg2, String arg3, String arg4, String arg5, String arg6, String arg7) throws Throwable {
        ...
        driver.findElement(By.id("dob")).sendKeys(arg4); //date of birth, calendar
        ...
        checkboxes.forEach(label -> {
            label.click();
            if(label.getAttribute("id").equalsIgnoreCase(arg5)){
                label.click();
            }
        });
        ...
        genders.forEach(label -> {
            label.click();
            if(label.getAttribute("id").equalsIgnoreCase(arg6)){
                label.click();
            }
        });
    ...
    public void click_on_edit_button1() throws Throwable {
        ...
        //driver.findElement(By.xpath("//span[@onclick='openModalForEditPerson(4)']")).click();
    }
